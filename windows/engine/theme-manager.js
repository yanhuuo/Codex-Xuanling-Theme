  ...
  `;
    ...
    const onPanelClick = (event) => {
        ...
        if (target.dataset.managerTab) {
            ...
            const sidebarFontFamily = panel.querySelector("[data-theme-sidebar-font-family]")?.value || "";
            const sidebarTextColor = panel.querySelector("[data-theme-sidebar-text-color]")?.value || "";
            const sidebarIconColor = panel.querySelector("[data-theme-sidebar-icon-color]")?.value || "";
