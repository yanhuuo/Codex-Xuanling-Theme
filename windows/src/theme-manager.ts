...
(() => {
  ...
  const closeButtonFromPoint = (event: MouseEvent | PointerEvent) => {
    ...
    for (const button of Array.from(panel.querySelectorAll<HTMLElement>(".dtm-close-hit[data-manager-close],.dtm-close-hit[data-local-theme-close],.dtm-close-hit[data-theme-pet-close]"))) {
  ...
  const onPanelClick = (event: MouseEvent) => {
    ...
    const closeTarget = element?.closest<HTMLElement>("[data-manager-close],[data-local-theme-close],[data-theme-pet-close]");
  ...
  const onPanelKeydown = (event: KeyboardEvent) => {
    ...
    const closeTarget = (event.target as Element | null)?.closest<HTMLElement>(".dtm-close-hit[data-manager-close],.dtm-close-hit[data-local-theme-close],.dtm-close-hit[data-theme-pet-close]");
